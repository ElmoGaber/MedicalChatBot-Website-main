...
app.mount("/static", StaticFiles(directory="D:\Downloads\MedicalChatBot-Website-main\src"), name="static")

# Root route → serve index.html
@app.get("/", response_class=HTMLResponse)
def serve_index():
    with open("D:\Downloads\MedicalChatBot-Website-main\src\index.html", "r", encoding="utf-8") as f:
        return f.read()
